...
// TODO add your handling code here:
        ...
        jListAdicionados.setListData(obj);
            ...
            disp[i] = get.getNome();
             ...
             for(int i = 0 ; i  < listaTreino.size();i++){
                 ...
                 mdl.addRow(new Object[]{trn.getAtividade().getNome(), trn.getAtividade().getDescr(), trn.getTempo()});
    ...
    private void salvar() {
        ...
        this.treino.setGrupoCollection(listaGrupo);
        this.treino.setTreinoatvCollection(listaTreino);
