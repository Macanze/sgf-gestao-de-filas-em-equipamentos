...
public class GRUPO_ATIVIDADE extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Selecionar", "ID", "Atividade", "Tempo Padrão"
            }
        ) {
    ...
    private void buscarAtividade() {
            ...
            this.lista= (ArrayList<Atividade>) daoServer.select(atv);
            
            listaAtividade = (ArrayList<GrupoAtividade>) grupo.query();
            ...
            for (Atividade a : lista) {
                ...
                mdl.addRow(new Object[]{false, a.getId(), a.getNome()});
    ...
    private void selecionarAtividade() {
        ...
        if (col == 0) {
            ...
            if(value){
                  ...
                  Atividade temp = lista.get(row);
            
            if (row != -1) {
             
              
              String tempo = JOptionPane.showInputDialog("Insira um tempo padrão");
              GrupoAtividade grp = new GrupoAtividade();
              grp.setAtividade(temp);
              grp.setGrupo(this.grupo);
              int time = Integer.parseInt(tempo);
              jTable1.setValueAt(time, row, 3);
              grp.setTempo(time);
              
              daoServer.insert(grp);
            //  listaAtividade.add(grp);                
